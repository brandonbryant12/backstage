...
/*
<ai_context>
Copied from @backstage/core-components to provide image support for EmptyState in MUI4 setup.
Used in conjunction with EmptyState to display visual cues for missing states.
</ai_context>
*/
